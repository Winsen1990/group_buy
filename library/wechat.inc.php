 ...
 * @param $message
 */
function send_template_message($template_id, $openid, $url, $message, $access_token)
{
    global $log;
    ...
    $wx_url = 'https://api.weixin.qq.com/cgi-bin/message/template/send?access_token='.$access_token;

    $data = urldecode(json_encode($data));
    $log->record($data);

    $response = post($wx_url, $data, false);
