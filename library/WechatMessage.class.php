...
class TextMessage extends WechatMessage
{
    protected $content;
...
class ImageMessage extends WechatMessage
{
    protected $mediaId;
...
class VoiceMessage extends WechatMessage
{
    protected $mediaId;
...
class VideoMessage extends WechatMessage
{
    protected $mediaId;
    protected $title;
...
class MusicMessage extends WechatMessage
{
    protected $title;
    protected $description;
    protected $musicUrl;
...
class NewsMessage extends WechatMessage
{
    protected $items;
...
class MultiServerTransfer extends WechatMessage
{
    protected $kfAccount;
